...
// TLSComplianceResult contains TLS/crypto compliance analysis (OWASP ASVS §9, PCI DSS 4.1, NIST SP 800-52r2)
...
type ComplianceStandards struct {
	...
	NIST80052r2 ComplianceStatus `json:"nist_sp_800_52r2"`
}
